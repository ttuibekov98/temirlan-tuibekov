(function(){
  ...
  var translations = {
    ru: {
      ...
      "hero.status":"Открыт к сильным аналитическим и digital-проектам на стыке инженерии, производства и цифровизации",
      "hero.name1":"Туйбеков", "hero.name2":"Темирлан",
      "hero.tagline":"Преобразую инженерные данные в управленческие решения с помощью цифровых инструментов.",
      "hero.lead":"Начинал с инженерных расчётов и механических систем в нефтегазовых проектах. Со временем дополнил инженерную экспертизу навыками Power BI, моделирования данных и аналитики — сегодня создаю KPI-дашборды и цифровые решения, которые превращают сложные производственные данные в понятную основу для управленческих решений.",
    ...
    en: {
      ...
      "hero.status":"Open to ambitious analytics & digital projects at the intersection of engineering, production and digitalization",
      "hero.name1":"Temirlan", "hero.name2":"Tuibekov",
      "hero.tagline":"I turn engineering data into management decisions with digital tools.",
      "hero.lead":"I started with engineering calculations and mechanical systems on oil & gas projects. Over time I added Power BI, data modeling and analytics skills — today I build KPI dashboards and digital solutions that turn complex production data into a clear basis for management decisions.",
